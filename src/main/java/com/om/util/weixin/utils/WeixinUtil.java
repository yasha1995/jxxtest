...
public class WeixinUtil {
    ...
    public static Map<String, Object> getWxConfig(HttpServletRequest request) {
        ...
        String appId = ConfigUtil.getProperty("wx_appid");//"wx4079b3c62a6f3b8b"; // 必填，公众号的唯一标识
        String secret = ConfigUtil.getProperty("wx_secret");//"d7b25eefde1e43c89b961dbf68c1fbcd";
